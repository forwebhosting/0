  ...
  return (
    <div className=" relative w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
     <div className="absolute inset-0 z-0">
      ...
      <img
        className="relative w-full h-64 object-cover rounded-lg mb-2"
        src={contactImg}
        alt="contactImg"
      />
      <div className=" relative flex flex-col gap-4">
        ...
        <p className="text-base text-gray-400 flex items-center gap-2" onClick={handlePhoneClick} style={{ cursor: "pointer" }}>
          Phone: <span className="text-lightText">+91 7845136624</span>
        </p>
        <p className="text-base text-gray-400 flex items-center gap-2" onClick={handleEmailClick} style={{ cursor: "pointer" }}>
          Email: <span className="text-lightText">mdthowfickinfo@gmail.com</span>
        </p>
      </div>
      <div className="relative flex flex-col gap-4">
